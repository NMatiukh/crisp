        ...
        <Space wrap>
            {
                allColors ?
                    optionsColor.map((value) =>
                        <div className={`${style.colorItemBlock} ${activeColor.includes(value.value) ? style.activeColorItem : null}`}
                    ...
                    :
                colors.map((value) =>
                    <div className={`${style.colorItemBlock} ${activeColor === value ? style.activeColorItem : null}`}
